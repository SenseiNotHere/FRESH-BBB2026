...
class DriveSubsystem(Subsystem):
    def __init__(self, maxSpeedScaleFactor=None) -> None:
        ...
        self.frontLeft = PhoenixSwerveModuleSubsystem(
        ...
        self.frontRight = PhoenixSwerveModuleSubsystem(
        ...
        self.backLeft = PhoenixSwerveModuleSubsystem(
        ...
        self.backRight = PhoenixSwerveModuleSubsystem(
    ...
    def periodic(self) -> None:
        ...
        # Data Puts
        # Pose
        SmartDashboard.putNumber("Drivetrain/X Coordinate", pose.x)
        SmartDashboard.putNumber("Drivetrain/Y Coordinate", pose.y)
        ...
        SmartDashboard.putNumber("FR Module/Front Right Position", self.frontRight.getPosition().angle.degrees())
        SmartDashboard.putNumber("BL Module/Back Left Position", self.backLeft.getPosition().angle.degrees())
        SmartDashboard.putNumber("BR Module/Back Right Position", self.backRight.getPosition().angle.degrees())
    ...
    def resetOdometry(self, pose: Pose2d, resetGyro=True, reason="unknown") -> None:
        ...
        SmartDashboard.putString("Drivetrain/ResetXY", f"{int(pose.rotation().degrees())} deg: {reason}")
